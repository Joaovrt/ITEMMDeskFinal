...
export default function ChamadosAtrasados({ navigation }) {
    ...
    async function getDados() {
        ...
        const q = query(collecRef, where("status", "==", "Atrasado"));
    ...
    if (loading) {
        ...
        return (
            ...
            >
                ...
                <Text style={styles.headerTitle}>Chamados Atrasados</Text>
                <FlatList
