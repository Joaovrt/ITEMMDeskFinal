...
export default function Departamentos({ navigation }) {
    const [departamento, setDepartamento] = useState([]);
    const [loading, setLoading] = useState(false);

    async function getDados() {
        setLoading(true);
        const collecRef = collection(database, 'Departamento');
        ...
        Alert.alert(
            ...
            [
                ...
                { 
                    ...
                    onPress: async () => {
                        try {
                            await deleteDoc(doc(database, 'Departamento', id));
                            getDados();
                        } catch (error) {
        ...
        return (
            ...
            >
                ...
                <TouchableOpacity
                    ...
                    onPress={() => navigation.navigate("CadastrarDepartamento")}
                >
